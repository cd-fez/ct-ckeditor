...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.extraPlugins = 'questionblank,smiley,table,font,kityformula,codesnippet,uploadpictures,shortUrl,image,colorbutton,colordialog,justify,flash,find,filebrowser,pasteimage,autocomplete,textwatcher,textmatch';
